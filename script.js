...
function showVeto() {
	blankAll();
	document.getElementById("cardVeto").innerHTML = /*html*/ `
    <div class="innerCard">
...
function blankAll() {
	document.getElementById("cardVeto").innerHTML = "";
...
function selectLeg1() {
    ...
    <button onclick="selectLeg4()">◀</button>
    <img src="img/legs1.png" />
    <button onclick="selectLeg2()">▶</button>
    `;
}

function selectLeg2() {
	document.getElementById("leg").innerHTML = /*html*/ `
    <button onclick="selectLeg1()">◀</button>
    <img src="img/legs2.png" />
    <button onclick="selectLeg3()">▶</button>
    `;
}
